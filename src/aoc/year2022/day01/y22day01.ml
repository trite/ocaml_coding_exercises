...
let () = most_calories test = 24000 |> O.verify

let () = most_calories data = 72017 |> O.verify
...
let () = sum_top_x_calories 3 test = 45000 |> O.verify

let () = sum_top_x_calories 3 data = 212520 |> O.verify
